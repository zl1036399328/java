 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/IDEA/WeatherWebService.wsdl")
public class WeatherWebService
    extends Service
{

    private final static URL WEATHERWEBSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(weather.WeatherWebService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = weather.WeatherWebService.class.getResource(".");
            url = new URL(baseUrl, "file:/E:/IDEA/WeatherWebService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/E:/IDEA/WeatherWebService.wsdl', retrying as a local file");
